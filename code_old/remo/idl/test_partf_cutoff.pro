...
; cutoff levels: fraction of ionisation energy
cutoffArr = [0.99, 0.95, 0.9, 0.75, 0.5, 0.25, 0.1]
...
; output PS file
   ...
   ps_file = elemIon+'_partf_cutoff.eps'
...
; legend
   ...
   yloc1 = yloc0 - dyloc
   cgText,xloc0,yloc0,'Cutoff level (fraction of E!Dion!N)'
   for icutoff=0L,ncutoff-1 do begin
      xloc = xloc1
