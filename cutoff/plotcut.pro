...
cgPS_open, 'wplot.eps', encapsulated=encapsulated, landscape=landscape, $
                 font=font, charsize=charsize, default_thick=default_thick, $
                 /nomatch
cgplot, xns, w2, col=color_1, thick=7, ytitle = 'Occupation probability', xtitle = 'effective principal quantum number n!u*!n'
cgplot, /ov, xns, w1, linest = 5, col=color_2, thick=7
cgplot, /ov, xns, w3, linest = 2, col=color_3, thick=7


xloc   = !x.crange[0]+(!x.crange[1]-!x.crange[0])*0.6
yloc   = !y.crange[0]+(!y.crange[1]-!y.crange[0])*0.3
cgLegend, Title=['4000 K', '6000 K', '8000 K'], $
                Lines=[5,0,2], thick=7, Color=[color_2,color_1,color_3], $
                charsize=charsize, charthick=charthick, vspace=1.8, length=0.125, $
                Location=[xloc,yloc], /Data, /background

cgps_close

cgPS_open, 'wplot_zoom.eps', encapsulated=encapsulated, landscape=landscape, $
                 font=font, charsize=charsize, default_thick=default_thick, $
                 /nomatch
