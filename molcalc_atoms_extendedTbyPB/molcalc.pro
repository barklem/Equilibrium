...
; calculate atomic partition functions
  ...
  print, IdStr+': calculating for atoms'
  for i=0, natom-1 do begin
     print, IdStr+': partition function: ',atomid[i]
...
; stop
  ...
  print, IdStr+': atomic partition functions: done'
...
; below we perform all tasks on each molecule in turn
  ...
  print,  IdStr+': calculating for molecules:'
